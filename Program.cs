...
namespace Gym_Equipment_Management{
    ...
    class GymEM{
        ...
        static void AddEquipment(){
            ...
            }else Console.WriteLine("Invalid input! Quantity must be a number.");
        }
        ...
        static void ViewHistory(){
            ...
            Console.WriteLine("\n--- History ---");
            if (history.Count == 0) Console.WriteLine("No history available.");
            else history.ForEach(Console.WriteLine);
        }
    }
}